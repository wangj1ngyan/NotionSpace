...
// 定义每种语言对应的欢迎语数组
const greetingWords = {
  'zh-CN': ['你好，我是一个图形学在读学生'],
  'en-US': ['Hi，I\'m an upcoming programmer'],
  'fr-FR': ['Bonjour，j\'écris parfois en français'],
  'ja-JP': ['日本語を勉強しているんだ'],
  'default': ['Welcome to my blog🎉'] // 默认欢迎语
};

// 默认语言
const defaultLanguage = process.env.NEXT_PUBLIC_LANG || 'zh-CN';

// 根据当前语言选择对应的欢迎语数组
const selectedGreetings = greetingWords[defaultLanguage] || greetingWords['default'];

// 将数组转换为字符串，并以逗号分隔
const selectedGreeting = selectedGreetings.join(',');
...
const BLOG = {
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', 'en-US', 'fr-FR', 'ja-JP', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: 2023, // e.g if leave this empty, current year will be used.
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'light', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  // 3.14.1版本后，欢迎语在此配置，英文逗号隔开 ,  即可支持多个欢迎语打字效果。
  // GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '你好，我是一个图形学在读学生,Hi，I\'m an upcoming programmer,Bonjour，j\'écris parfois en français,日本語を勉強しているんだ,Welcome to my blog🎉',
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || selectedGreeting,
  
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wangj1ngyan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '喜欢买买买和吃吃吃🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '图形学, leetcode, 游记', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'joannawjy0179@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/wangj1ngyan', // 你的github个人主页 例如 https://github.com/tangly1024
